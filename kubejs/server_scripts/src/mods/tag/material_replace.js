ServerEvents.recipes( event => {
    ...
    const replaceInput = [
        ...
        },
        {
            ...
            replace: 'gtceu:enderium_ingot'
        },
        {
            input: 'thermal:signalum_ingot',
            replace: 'gtceu:signalum_ingot'
        },
        {
            input: 'thermal:lumium_ingot',
            replace: 'gtceu:lumium_ingot'
        },
        {
            input: 'xycraft_world:aluminum_ingot',
            replace: 'gtceu:aluminium_ingot'
        },
        {
            input: 'xycraft_world:aluminum_nugget',
            replace: 'gtceu:aluminium_nugget'
        }
    ];
