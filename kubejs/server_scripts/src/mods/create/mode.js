ServerEvents.recipes( e =>{
    e.recipes.createMixing('2x galaxy_greg:grout_dust', ['1x gtceu:quartz_sand_dust', '1x gtceu:flint_dust', '1x gtceu:clay_dust', Fluid.of("minecraft:water", 100)]).id('tconstruct:smeltery/seared/grout_multiple')
    ...
    e.recipes.createMixing('gtceu:red_alloy_dust', ['4x minecraft:redstone', '1x gtceu:copper_dust']).lowheated().id('create:mixing/red_alloy_dust')
    ...
    e.recipes.createPressing('gtceu:red_alloy_plate', 'gtceu:red_alloy_ingot').id('create:pressing/red_alloy_plate')
    e.recipes.createPressing('gtceu:tin_plate', 'gtceu:tin_ingot').id('create:pressing/tin_plate')

    e.recipes.create.item_application('ctpp:ulv_kinetic_input_box', ['gtceu:ulv_machine_hull', 'create:shaft'])
